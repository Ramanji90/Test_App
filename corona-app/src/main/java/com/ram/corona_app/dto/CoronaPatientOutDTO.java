...
public class CoronaPatientOutDTO implements Serializable
{
	...
	private String patientName;
	   ...
	   public String getPatientName() {
		...
		public String toString() {
			return "CoronaPatientOutDTO [patientName=" + patientName + ", patientAddr=" + patientAddr + ", mobileNo="
					+ mobileNo + ", noOfDaysHospitalized=" + noOfDaysHospitalized + ", billPerDay=" + billPerDay
